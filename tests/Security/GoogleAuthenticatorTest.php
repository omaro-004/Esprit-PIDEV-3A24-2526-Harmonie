...
class GoogleAuthenticatorTest extends TestCase
{
    ...
    private function createAuthenticator(
        ...
        return new class($clientRegistry, $em, $router, $repo) extends GoogleAuthenticator {
    ...
    public function testAuthenticateErreurSiEmailManquant(): void
    {
        ...
        $clientRegistry->method('getClient')->with('google')->willReturn($client);
    ...
    public function testAuthenticateRetourneUtilisateurExistantParGoogleId(): void
    {
        $googleUser = $this->createMock(GoogleUser::class);
        $googleUser->method('getEmail')->willReturn('a@b.com');
    ...
    public function testAuthenticateLieUtilisateurParEmail(): void
    {
        ...
        $googleUser->method('getAvatar')->willReturn('http://img/google.png');
        ...
        $this->assertSame('http://img/google.png', $user->getOauthAvatarUrl());
    }
    ...
    public function testAuthenticateCreeNouvelUtilisateurSiAucunMatch(): void
    {
        ...
        $googleUser->method('getId')->willReturn('g-4');
        ...
        $this->assertSame('g-4', $user->getGoogleId());
