...
class RoomRequestCasLimitesTest extends TestCase
{
    ...
    /**
     * Teste le nombre maximum de participants (non applicable à l'entité RoomRequest).
     */
    public function testMaximumNumberOfParticipants(): void
    {
        $this->markTestSkipped('Pas de champ participants dans DemandeReservation.');
    }

    /**
     * Teste que zéro participant est géré (non applicable à l'entité RoomRequest).
     */
