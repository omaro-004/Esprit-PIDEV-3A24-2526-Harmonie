...
class TaskCasLimitesTest extends TestCase
{
    ...
    /**
     * Teste le nombre maximum de participants (non applicable à l'entité Task).
     */
    public function testMaximumNumberOfParticipants(): void
    {
        $this->markTestSkipped('Pas de champ participants dans Tache.');
    }

    /**
     * Teste que zéro participant est géré (non applicable à l'entité Task).
     */
